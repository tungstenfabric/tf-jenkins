...
if [[ ${LINUX_DISTR} == 'rhel7' ]]; then
  mirror_list_for_build="mirror-epel.repo google-chrome.repo mirror-rhel8-baseos.repo"
  ...
  mirror_list_for_build="mirror-epel.repo google-chrome.repo ubi.repo mirror-rhel7.repo mirror-rhel8-baseos.repo"
