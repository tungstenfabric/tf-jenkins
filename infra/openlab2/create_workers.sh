...
echo "export instance_ip=${JUJU_CONTROLLER[VM_IP_ADDRESS]}" >> "$ENV_FILE"
echo "export JUJU_CONTROLLER_NODES=${JUJU_CONTROLLER[VM_IP_ADDRESS]}" >> "$ENV_FILE"
echo "export MAAS_CONTROLLER=${MAAS_CONTROLLER[VM_IP_ADDRESS]}" >> "$ENV_FILE"
