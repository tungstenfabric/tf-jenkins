...
[epel]
name=epel
baseurl=http://tf-mirrors.$CI_DOMAIN/repos/yum7/epel
enabled=0
gpgcheck=0
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-rpms
enabled = 1
gpgcheck = 1
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-optional-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-extras-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-openstack-13-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-openstack-13-devtools-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-ansible-2.6-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-fast-datapath-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-server-rhscl-7-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-ha-for-rhel-7-server-rpms
enabled = 1
gpgcheck = 1
gpgkey = file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
baseurl = http://tf-mirrors.$CI_DOMAIN/repos/rhel7/latest/rhel-7-server-rhceph-3-tools-rpms
enabled = 1
gpgcheck = 0
cost = 600
