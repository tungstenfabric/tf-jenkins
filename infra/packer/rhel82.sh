...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/rhel-8-for-x86_64-baseos-rpms/
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/rhel-8-for-x86_64-appstream-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/openstack-16.1-for-rhel-8-x86_64-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/satellite-tools-6.5-for-rhel-8-x86_64-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/ansible-2-for-rhel-8-x86_64-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/rhel-8-for-x86_64-highavailability-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/fast-datapath-for-rhel-8-x86_64-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
...
enabled=1
gpgcheck=1
baseurl=http://tf-mirrors.$SLAVE_REGION.$CI_DOMAIN/repos/rhel82/latest/rhceph-4-tools-for-rhel-8-x86_64-rpms/
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
cost = 600
