...
SITE_MIRROR="http://nexus.${SLAVE_REGION}.${CI_DOMAIN}/repository"
// for ssh purpose
...
LOGS_BASE_URL = "http://nexus.${SLAVE_REGION}.${CI_DOMAIN}:8082/jenkins_logs"
